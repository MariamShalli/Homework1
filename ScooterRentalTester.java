/**
 * The ScooterRentalTester class is used to simulate the process of renting and returning scooters.
 */
public class ScooterRentalTester {
    ...
    // Instance of RentalCompany to manage the scooters.
    ...
    /**
     * Constructor for ScooterRentalTester which initializes the rental company instance.
     */
    ...
    public void simulateScooterRentalProcess() {
        ...
        System.out.println("Scooter rented and traveling to university.");
        rentalCompany.returnScooter(scooter.getId(), UNIVERSITY_X, UNIVERSITY_Y);
        System.out.println("Scooter returned at university location.");
        ...
        rentalCompany.rentScooter(scooter.getId());
        System.out.println("Scooter rented again and traveling near home.");
        rentalCompany.returnScooter(scooter.getId(), HOME_X, HOME_Y);
        System.out.println("Scooter returned near home location.");
    }
}
